...
//! ActivityPub server runtime for Feder on standard operating systems.
//!
//! This crate connects [`feder_core`] protocol decisions to Axum, SQLite,
//! remote actor resolution, HTTP signatures, and activity delivery.
pub mod actor;
pub mod config;
pub mod follow;
pub mod followers;
...
pub use feder_core::ActorDispatcher;
use feder_core::storage::{NoteStore, ServerStorage};
